...
" Last Updated: 金  6/30 03:59:29 2023
...
if &background ==# 'dark'
  ...
  hi DiffDelete guifg=#444444 guibg=#444444 gui=NONE cterm=NONE
  ...
  hi LspErrorHighlight guifg=#00c4cc gui=NONE cterm=NONE
  if !s:italics
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi DiffDelete ctermfg=238 ctermbg=238 cterm=NONE
    ...
    hi LspErrorHighlight ctermfg=45 cterm=NONE
    if !s:italics
...
if s:t_Co >= 8
  if &background ==# 'dark'
    ...
    hi DiffChange ctermfg=NONE ctermbg=NONE cterm=NONE
    hi DiffDelete ctermfg=Grey ctermbg=Grey cterm=NONE
    ...
    hi LspErrorHighlight ctermfg=LightBlue cterm=NONE
    if !s:italics
      hi Comment cterm=bold
    endif
  else
